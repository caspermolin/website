...
import { X, Save, Plus, Trash2, Settings, Upload } from 'lucide-react';
...
interface ServicesDetailedEditorProps {
  block: any;
  onSave: (updatedBlock: any) => void;
  onClose: () => void;
}

export default function ServicesDetailedEditor({ block, onSave, onClose }: ServicesDetailedEditorProps) {
  const [title, setTitle] = useState(block.content?.title || '');
  const [subtitle, setSubtitle] = useState(block.content?.subtitle || '');
  const [services, setServices] = useState<Service[]>(block.content?.services || []);
            ...
            {services.map((service, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-lg font-medium text-gray-900">Service {index + 1}</h4>
                  <button
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        rows={4}
                        placeholder="Complete audio post production services..."
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Starting from €500/day"
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          placeholder="/images/icons/audio-post.svg"
                        />
