...
import { X, Save, Plus, Trash2, Calendar, Upload } from 'lucide-react';
...
export default function TimelineEditor({ block, onSave, onClose }: TimelineEditorProps) {
  const [title, setTitle] = useState(block.content?.title || '');
  const [subtitle, setSubtitle] = useState(block.content?.subtitle || '');
  const [timeline, setTimeline] = useState<TimelineItem[]>(block.content?.timeline || []);
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900">Timeline Items</h3>
              <button
            ...
            {timeline.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-lg font-medium text-gray-900">Timeline Item {index + 1}</h4>
                  <button
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        rows={4}
                        placeholder="We started our journey with a vision to..."
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          placeholder="/images/timeline/2020.jpg"
                        />
