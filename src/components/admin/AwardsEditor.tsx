...
import { X, Save, Plus, Trash2, Award, Upload } from 'lucide-react';
...
export default function AwardsEditor({ block, onSave, onClose }: AwardsEditorProps) {
  const [title, setTitle] = useState(block.content?.title || '');
  const [subtitle, setSubtitle] = useState(block.content?.subtitle || '');
  const [awards, setAwards] = useState<AwardItem[]>(block.content?.awards || []);
          ...
          <div className="mb-8 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Industry recognition for our excellence"
              />
            </div>
          </div>
            ...
            {awards.map((award, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-lg font-medium text-gray-900">Award {index + 1}</h4>
                  <button
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Best Audio Post Production"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Audio Industry Awards"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        rows={3}
                        placeholder="Recognized for outstanding work on..."
                      />
                    </div>
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Award Image (Optional)</label>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          placeholder="/images/awards/award-2023.jpg"
                        />
